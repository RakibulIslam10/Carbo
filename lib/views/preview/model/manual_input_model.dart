...
//
//     final manualInputModel = manualInputModelFromJson(jsonString);

import 'dart:convert';

ManualInputModel manualInputModelFromJson(String str) => ManualInputModel.fromJson(json.decode(str));

String manualInputModelToJson(ManualInputModel data) => json.encode(data.toJson());
...
class ManualInputModel {
  ...
  factory ManualInputModel.fromJson(Map<String, dynamic> json) => ManualInputModel(
