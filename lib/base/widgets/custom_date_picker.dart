...
class CustomDatePicker extends StatefulWidget {
  ...
  const CustomDatePicker({
    ...
    this.leading,
    this.fieldPadding,
    Key? key, this.labelFontSize, this.hintFontSize, this.labelSpacing, required this.showBorder,
  }) : super(key: key);
            ...
            decoration: widget.decoration ??
                BoxDecoration(
                  ...
                  border: widget.showBorder == true
                      ? Border.all(
                    color: isDatePickerOpened ? CustomColor.primary : Colors.grey,
                            ...
                            child: Column(
                              ...
                              children: [
                                TextWidget(
                                  ...
                                  fontSize: widget.hintFontSize ?? Dimensions.titleSmall,
